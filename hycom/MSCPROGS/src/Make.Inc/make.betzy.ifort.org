...
#NETCDF_INCLUDE_OPTS=/cluster/software/netCDF-Fortran/4.6.0-iimpi-2022a/include
...
#FFLAGS= -g -convert big_endian -assume byterecl -cm -vec_reprot0 -O2 -r8 -I$(NETCDF_INCLUDE_OPTS)
...
#LD_LIBRARY_PATH=/cluster/software/netCDF-Fortran/4.5.2-iimpi-2020a/lib:/cluster/software/netCDF/4.7.4-iimpi-2020a/lib64:$LD_LIBRARY_PATH
